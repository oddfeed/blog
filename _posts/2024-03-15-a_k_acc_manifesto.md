...
1.  [a k/acc manifesto](#orgea59ebb)
    1.  [Accelerationism](#org45b231d)
    2.  [Criticism of (x)/acc](#org260ef71)
    3.  [Accelerationism as natural process](#org62788d1)
    4.  [What is k/acc?](#org1224600)
    5.  [Why k/acc has to be the first step](#org079a074)
    6.  [Directive of k/acc](#orgdf39e6d)
...
Accelerationism is seen as either a hateful, aggressive militant ideology or as a natural forming process - as complexity increases, capacity follows then it&rsquo;s only natural that things will get quicker. Some argue acc started with marx others argue it started with land I&rsquo;m of the view marx was the origin and land was the form (though nick land should no longer be taken seriously, he now just boomer posts on twitter, at this point it&rsquo;s not even worth reading his work directly since it&rsquo;s explained in other works in a much more accessable form) Marx saw acc as a function of capitalism that could be stopped, overcame. Land saw it as unstoppable so embracing it is all that&rsquo;s left - since then people have expanded it further - the most fitting analogy is that of a train, we&rsquo;re sat on a train marxs looks out the window and notices it&rsquo;s speeding up with no chance of stopping, he looks further down the track and sees the tracks ending, he wants the train to be slowed down and hopefully stopped - land looks out of the window and reaches the conclusion the train will only ever speed up so we should try and speed it up as much as possible to get it over and done with.

Extended from this is the idea of &ldquo;clearing the pit&rdquo; the train gets so much speed it&rsquo;s existing momentum at the moment of derailing might keep us going until we either land on another track or until we can build one.

One common myth is that accelerationism is right leaning, this was not true of marx and (kind of) wasn&rsquo;t true of nick land or the CCRU - included in accelerationism is l/acc seeking to reach automated luxery communism, g/acc seeking to abolish the concept of gender, xenofeminism seeking to use capitalism and acc to remove gender inequality to establish true feminism. CCRU was a very left leaning group and most if not all excluding land went on and continued to be incredibly impactful left leaning thinkers, two recognisable cases being sadie plant and mark fisher - claiming acc as right leaning wipes out all of the wokr done and being done by left leaning thinkers - just because right leaning people dominate acc spaces on twitter doesn&rsquo;t mean they are the ideology, as is mostly the left has allowed the right to claim ownership over some thing that should rightfully belong to the left.
...
The issues with most acc subgenres is they lack coherence, formal value sets and any actual structure - they mostly fall into the catagory of thing/acc with no actual considerations
A logical prerequesit (that I&rsquo;m currently violating) should be to write an outline of your thing/acc before you can put it in your twitter name or bio - watch almost any interview with accelerationists and you&rsquo;ll see quickly how they&rsquo;ve never thought about what it actually means.

[Beff explains eacc to lex](https://www.youtube.com/watch?v=4Oj7m3F0ifI)

It&rsquo;s obvious from this clip that beff could explain it in simple language but chooses not to, I agree with feynman if you can&rsquo;t explain it to a layman you don&rsquo;t have a good enough grasp on it - watch that entire clip then ask what should an e/accer actually do? it&rsquo;s laid out a value set but not a formal structure, an interesting note on that vidoe is beff claims d/acc as a fork to e/acc but I don&rsquo;t know why he beleives this from the opening lines of [the d/acc manifesto](https://vitalik.eth.limo/general/2023/11/27/techno_optimism.html) he explains it&rsquo;s meant as a response to andreessens techno-optimist manifesto which makes me question if beff has even read it, e/acc is barely mentioned - but this isn&rsquo;t meant to be focused too much on beff but unfortunately he&rsquo;s the central figure and most notable in acc spaces right now even though I honest to god do not know if he&rsquo;s doing anything beyond posting on twitter, he talks like he&rsquo;s incredibly important but I&rsquo;ve yet see anyone point to a solid thing he&rsquo;s done, he&rsquo;s talked about how vital open source and working in public is to progress but is incredibly evasive about the things he&rsquo;s doing/working on - I&rsquo;m not making the claim he&rsquo;s a liar or a scammer moreso just if it&rsquo;s impossible to verify if someones doing something it&rsquo;s concerning - from his use of language in the clip he is knowlegable about accelerationism and seemingly the ideas of deluze and the other one but that&rsquo;s what makes it even more frustrating right now (x)/acc is going through such a level of decentralisation that it&rsquo;s fracturing and now the power is distributed among too many nodes and it&rsquo;s potential for power growth is highly limited due to people aprehension of AI - meanwhile tenents of k/acc continue to grow in the mainstream.
...
As a small note here I want to point out complexity `/` complicatedness, the design, manufacture and shipping of a toothbrush is highly complex, it&rsquo;s also not complicated.
